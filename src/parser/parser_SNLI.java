...
public class parser_SNLI {
	public static void main(String[] args) {
	    ...
	    try {
	    	File in = new File("/home/galsang/PycharmProjects/own_spinn/.data/snli/snli_1.0/snli_1.0_test_hard.jsonl");
	    	File out = new File("/home/galsang/PycharmProjects/own_spinn/.data/snli/parsed/test_hard.jsonl");
	    	...
	    	while((line = bufReader.readLine()) != null) {
	    	    ...
	    	    json.put("sentence1_tagged_binary_parse", collapsedUnary.toString());
	    	    ...
	    	    json.put("sentence2_tagged_binary_parse", collapsedUnary.toString());
